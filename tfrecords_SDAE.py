...
class SDAE(object):
    ...
    def train(self):
        ...
        for i in range(self.n_layers):
            ...
            write_tfrecords(self.data_dir, 'train_feature_'+str(i), layer.next_x)
            write_tfrecords(self.data_dir, 'val_feature_' + str(i), layer.next_x_val)
            # 更新数据生成器
            data_generator_train = data_generator_tfrecords(self.data_dir + 'train_feature_'+str(i)+'.tfrecords',
                                                            layer.next_x.shape, n_batch, batch_size=self.batch_size)
            data_generator_val = data_generator_tfrecords(self.data_dir + 'val_feature_'+str(i)+'.tfrecords',
